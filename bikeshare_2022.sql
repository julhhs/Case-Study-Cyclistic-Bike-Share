...
-- Checking max and min number to see if there are any outlier in 'started' and 'ended' time. 
...
-- Calculating the average ride duration for both member and casual riders

SELECT 
    member_casual,
    AVG(ride_length) AS avg_ride_length_mins
FROM 
    [Bike-Share].[dbo].[bikeshare_2022]
GROUP BY
    member_casual
